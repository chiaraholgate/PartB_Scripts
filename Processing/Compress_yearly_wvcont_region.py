...
* Note that a new MDB mask has been made since running this script for MDB.
...
if region == 'Australia':
    ...
    fh.close()
if region == 'MDB':
    fh = Dataset(dir_mask+'Aus_Drainage_Divisions/geofabric/Divisions/netcdf/MurrayDarlingBasin.nc', mode='r') 
...
for year in Yearlist:
    ...
    for d in daylist:
        ...
        file = dir_out+domain+'/100parcels/TS10min/exp01/'+fname
...
#                        rain_idx.append(r)
    ...
    ofile = dir_out+domain+'/100parcels/TS10min/exp01/Processed/Yearly/'+region+'_'+str(year)+'_wvcont.nc'    
