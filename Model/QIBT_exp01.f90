...
INTEGER :: sday = 2,smon = 5,syear = 2013    !start day for calculations (INCLUSIVE)
INTEGER :: edday = 31,edmon = 12,edyear = 2013  !end day for calculations (must be at least one day after start day) (EXCLUSIVE)
INTEGER :: totdays
