...
INTEGER :: sday = 24,smon = 6,syear = 1983    !start day for calculations (INCLUSIVE)
INTEGER :: edday = 1,edmon = 1,edyear = 1984  !end day for calculations (must be at least one day after start day) (EXCLUSIVE)
INTEGER :: totdays
