...
INTEGER :: edday = 2,edmon = 2,edyear = 1979  !end day for calculations (must be at least one day after start day)
INTEGER :: totdays
...
print *,'L616 get_filename for :',d,mn,yr
print *,'L617 filename_ext_atm= ',filename_ext_atm 
...
! print *,'L687, outfile=',TRIM(diro)//"bt."//TRIM(int_to_string(year))//"0" &
!   		//TRIM(int_to_string(mon))//"_"//TRIM(int_to_string(INT(daynum)))// &
! 		".nc"
...
!first get the qt
print *,'get_data: L874, first call to get filename in get_data_mixtot'
call get_data_mixtot(qc,qt)

print *,'get_data: L876, get filename of sim day'
...
if (totbtadays>1) then
	...
	print *,'get_data: L961, Input file of first day loaded successfully:',filename_ext_atm
	...
	do i = 1,totbtadays
		...
		!print *,'get_data: L974, jd_before,new_y,new_m,new_d=',jd_before,new_y,new_m,new_d
		...
		print *,'get_data: L1032, Input file of previous day loaded successfully:',i,filename_ext_atm
	...
	call gregorian(jd_before,new_y,new_m,new_d)
	!print *,'get_data: L1050, "day-after" date=',jd_before,new_y,new_m,new_d
	call get_filename(new_d,new_m,new_y,filename_ext_atm,filename_ext_RAIN,filename_ext_LH,filename_ext_P)
	call open_netcdf_files(ncid,prencid,lhncid,psfcncid,preid,lhid,uid,vid,wid,tid,qid,ppid,pbid,pblid,psfcid,filename_ext_atm,filename_ext_RAIN,filename_ext_LH,filename_ext_P)
	...
	print *,'get_data: L1114, Input file of next day (1st time step) loaded successfully:',filename_ext_atm
	
else
	print *,'get_data: L1117, Input file of sim day loaded successfully:',filename_ext_atm
	...
	call get_filename(new_d,new_m,new_y,filename_ext_atm,filename_ext_RAIN,filename_ext_LH,filename_ext_P)
	call open_netcdf_files(ncid,prencid,lhncid,psfcncid,preid,lhid,uid,vid,wid,tid,qid,ppid,pbid,pblid,psfcid,filename_ext_atm,filename_ext_RAIN,filename_ext_LH,filename_ext_P)
	print *,'get_data: L1191, sim day - 1:',filename_ext_atm
	...
	call get_filename(new_d,new_m,new_y,filename_ext_atm,filename_ext_RAIN,filename_ext_LH,filename_ext_P)
	call open_netcdf_files(ncid,prencid,lhncid,psfcncid,preid,lhid,uid,vid,wid,tid,qid,ppid,pbid,pblid,psfcid,filename_ext_atm,filename_ext_RAIN,filename_ext_LH,filename_ext_P)
	print *,'get_data: L1258, sim day + 1:',filename_ext_atm
...
print *,'get_data_mixtot, L1427, call to get_filename'
call get_filename(day,mon,year,filename_ext_atm,filename_ext_RAIN,filename_ext_LH,filename_ext_P)
...
if (totbtadays>1) then
	...
	print *,'get_data_mixtot: L1714, Input file of first day loaded successfully:',filename_ext_atm
	...
	do i = 1,totbtadays
		...
		print *,'get_data_mixtot: L1754, Input file of previous day loaded successfully:',i,filename_ext_atm
...
do dd = 1, totdays
  ...
  print *,"L2850, simulation day,mon,year",day,mon,year  
