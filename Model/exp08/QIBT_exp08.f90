...
!%%%%%%% ASSUMPTIONS %%%%%%%
! All forms of water are included (vapour, rain, ice, snow, cloud water) in the parcel's mixing ratio. Only vapour is used in the total precipitable water calculation, which is used to normalise the contribution of evaporation from a cell, and in the precipitatble water calculation, which is used to determine the parcel's release height.
...
! print *,'L1738, par_release=',par_release
...
! print *,'L1758, rand_num, size(pw)=',rand_num,size(pw)

rand_num = 1 + FLOOR(size(pw)*rand_num)
! print *,'L1761, rand_num=',rand_num
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	  do mm = 1, par_release(tt)
	    ...
	    !print *, 'xx,yy,npar,tt,mm,par_lev= ', xx,yy,npar,tt,mm,par_lev
! 	    print *, 'xx,yy,npar,tt= ', xx,yy,npar,tt
