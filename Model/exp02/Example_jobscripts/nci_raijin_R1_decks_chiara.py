...
while (year < end_year or (year == end_year and month <= end_month)):
    ...
    for dd in range(1,per_month+1):
        ...
        if (dd < per_month):
            ...
            edaystr = "01"
            eday = int(days_in_month[month-1]/per_month)
        ...
        fin = open ('/home/z3131380/hdrive/PhD/PartB/Scripts/Model/Example_jobscripts/'+indeck,"r") 

        #open the deck I am creating
        fout = open ("/home/z3131380/hdrive/PhD/PartB/Scripts/Model/Example_jobscripts/run_QIBT_exp02_%s_%s_%s.deck"%(year,monthstr,sdaystr),"w")
